...
m_factor_intermediate = intermediate_df['m_factor'].values
...
m_factor_over_ln_n_over_ln_ln_n = m_factor / np.log(n) * np.log(np.log(n))
m_factor_over_ln_ln_n_over_ln_2 = m_factor / np.log(np.log(n)) * np.log(2)
...
plots = [
    ...
    ("r_factor_vs_n", n, r_factor, n_intermediate, r_factor_intermediate,
        r"$r(n)$", r"$n$", r"$r(n)$"),
    # d = 1
    ("m_d=1_factor_vs_n", n, m_factor, n_intermediate,
     m_factor_intermediate, r"$l_n^{(1)}$", r"$n$", r"$l_n(n)$"),
    ("m_d=1_factor_over_ln_n_over_ln_ln_n_vs_n", n, m_factor_over_ln_n_over_ln_ln_n, n_intermediate, m_factor_intermediate / np.log(n_intermediate) * np.log(np.log(n_intermediate)),
        r"$l_n^{(1)} \cdot \frac{1}{f_1(n)}$", r"$n$", r"$\frac{m(n)}{\ln n \ln \ln n}$")
    # d = 2
    # ("m_d=2_factor_vs_n", n, m_factor, n_intermediate,
    #  m_factor_intermediate, r"$l_n^{(2)}$", r"$n$", r"$l_n(n)$"),
    # ("m_d=2_factor_over_ln_ln_n_over_ln_2_vs_n", n, m_factor_over_ln_ln_n_over_ln_2, n_intermediate, m_factor_intermediate / np.log(np.log(n_intermediate)) * np.log(2),
    #     r"$l_n^{(2)} \cdot \frac{1}{f_2(n)}$", r"$n$", r"$\frac{m(n)}{\ln \ln n / \ln 2}$")
]
