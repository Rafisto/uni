...
void run_p2p(const std::string& gr_file, const std::string& p2p_file, const std::string& op2p_file) {
    ...
    if (pairs.size() == 0) pairs[0] = {1, nodes};
...
int main(int argc, char* argv[]) {
    if (argc < 6) {
        std::cerr << "Usage: dijkstra -d <data_file> -ss <source_file> -oss <output_file>\n";
        std::cerr << "Usage: dijkstra -d <data_file> -p2p <pairs_file> -op2p <output_file>\n";
        return 1;
    }
