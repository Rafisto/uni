...
public:
    ...
    /**
     * @brief Function to convert a value of type T to a string representation.
     *
     * @tparam T - type of value to convert to string
     * @param val - value to convert
     * @return string representation of the value
     */
    template <typename T>
    static std::string valToString(const T& val)
    {
        std::stringstream ss;
        ss << val;
        return ss.str();
