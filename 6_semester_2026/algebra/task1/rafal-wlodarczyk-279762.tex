...
LCM = 14x^5 + 30.628816219770492x^4 + 42.554756687034x^3 + 
      + 119.8183226457778x^2 + 133.04340632545495x + 153.48864962269494
    \end{verbatim}
\end{itemize}
...
ale w praktyce jest znacznie lepsza, ponieważ $|\text{MIN}| \ll |A|$ dla zadanych danych (szacujemy takim bounding box-em, 
w granicach rozsądku - kwadratu wokoł okręgu i jego dolnego zarysu).

\begin{itemize}
    \item  Szukamy elementów $\leq$-minimalnych w zbiorze
    $A = \{(x,y)\in \mathbb{N}^2 : (x-a)^2 + (y-b)^2 < 5\}$, gdzie $a=2$ i $b=7$.
\begin{verbatim}
Count Min elements of A: 3
Min elements of A:
[0, 7],[1, 6],[2, 5]
\end{verbatim}
    \item Następnie szukamy elementów $\leq$-minimalnych w zbiorze
    $B = \{(x_1,x_2,x_3,x_4) \in \mathbb{N}^4 : (x_1-c)^2 + (x_2-d)^2 + (x_3-e)^2 + (x_4-f)^2 > 224\}$, gdzie $c=9$, $d=7$, $e=6$ i $f=2$.
\begin{verbatim}
