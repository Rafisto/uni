...
void test_op_add() {
  ...
  assert((op1 + op2).repr() == 1);

  Ring<15> oq1(4);
  Ring<15> oq2(9);

  // 4 + 9 = 13 (mod 15)
  assert((oq1 + oq2).repr() == 13);

  // 4 + 4 + 9 = 17 = 2 (mod 15)
  assert((oq1 + oq1 + oq2).repr() == 2);
...
void test_op_sub() {
  ...
  // 13 - 9 = 4 (mod 17)
  assert((op2 - op1).repr() == 4);

  // 9 - 13 = -4 -> 17 - 4 = 13 (mod 17)
  assert((op1 - op2).repr() == 13);

  Ring<15> oq1(9);
  Ring<15> oq2(13);

  // 13 - 9 = 4 (mod 15)
  assert((oq2 - oq1).repr() == 4);

  // 9 - 13 = -4 -> 15-4 = 11 (mod 15)
  assert((oq1 - oq2).repr() == 11);
...
void test_op_mul() {
  ...
  // 9 * 13 = 117 = 15 (mod 17)
  assert((op1 * op2).repr() == 15);

  Ring<15> oq1(9);
  Ring<15> oq2(13);

  assert((oq1 * oq2).repr() == 12);
